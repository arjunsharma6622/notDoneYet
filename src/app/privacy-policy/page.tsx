    ...
    return (
        <div className='m-6 flex flex-col gap-6'>
            <div className='flex flex-col gap-2'>
                ...
                <p className='text-gray-500 text-sm'>Last updated: August 25, 2024</p>
            </div>
            ...
            <div className='flex flex-col gap-4'>
                ...
                <ul className='list-disc'>
                    ...
                    <li>
                        <p><strong>Application</strong> refers to Not Done Yet, the software program provided by the Company.</p>
                    </li>
                    <li>
                        <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Not Done Yet.</p>
                    </li>
                    <li>
            ...
            <div>
                ...
                <ul className='list-disc'>
                    <li>By email : support@notdoneyet.in</li>
                </ul>
            </div>
        </div>
    )
