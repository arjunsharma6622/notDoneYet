...
const ConversationCard = ({ session, conversation, otherUser, lastMessage, setCurrentConversation, currentConversation, setNewUserToSendMsg, setWriteNewMsg } : any) => {
  ...
  return (
    ...
    onClick={() => {setCurrentConversation(conversation); setNewUserToSendMsg(null); setWriteNewMsg(null)}}
