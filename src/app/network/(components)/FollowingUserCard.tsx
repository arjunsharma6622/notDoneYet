...
const FollowingUserCard = ({follow, following, index, session} : {follow : any, following : any, index : number, session : any}) => {
  ...
  return (
    <div className={`flex gap-2 items-center justify-between py-5 ${index !== following.length - 1 && 'border-b border-gray-300'}`}>
