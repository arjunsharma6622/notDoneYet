...
const PostForm = ({ open, setOpen, user } : { open: boolean, setOpen: (open: boolean) => void, user: any }) => {
                            ...
                            <div className="px-6">
                                <div className="border rounded-md p-3 flex flex-col gap-3 overflow-y-scroll">
                                    ...
                                    <div className="flex items-center gap-2">
                                        ...
                                        <p className="text-xs text-gray-400">Only .png, .jpg, .jpeg files are allowed</p>
                                    </div>
                                </div>
                            </div>
