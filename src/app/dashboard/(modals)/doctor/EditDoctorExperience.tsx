...
const EditDoctorExperience = ({ user, open, setOpen } : { user: any, open: boolean, setOpen: any }) => {
  ...
  useEffect(() => {
    ...
    reset({...selectedExperience, startDate : dateFormat(selectedExperience?.startDate, "isoDate"), endDate : dateFormat(selectedExperience?.endDate, "isoDate")});
              ...
              <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-6 overflow-scroll">
                <div className="flex flex-col gap-6 px-6 py-4 overflow-y-scroll">
                  <div className="flex flex-col gap-2">
                    <h2 className="text-xl font-semibold underline">Edit Experience</h2>
                    <div className="flex flex-col gap-4">
                      ...
                      <div className="flex items-center justify-between w-full gap-6">
                        ...
                        <div className="w-full">
                          <label htmlFor="experienceSpecialization">Specialization</label>
                          <input
                            type="text"
              ...
              <div className="flex flex-col gap-4 pb-4 px-6">
                {user.experience?.map((experience : any, index : number) => (
                  <div key={index} className="px-6 py-2 bg-gray-200 flex items-center gap-6 border rounded-md w-fit">
                    ...
                    {experience.title} . {experience.organization} . {dateFormat(experience.startDate, "mmmm, yyyy")} - {dateFormat(experience.endDate, "mmmm, yyyy")}
